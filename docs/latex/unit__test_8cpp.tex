...
\DoxyCodeLine{97                                                         \{}
\DoxyCodeLine{98 }
\DoxyCodeLine{99     assert(ptr\_ex\_eq != NULL);}
\DoxyCodeLine{100 }
\DoxyCodeLine{101     ptr\_ex\_eq-\/>\mbox{\hyperlink{structexpected__eq_a7f76d73438937c34157f649c5817aebc}{test\_eq}}.\mbox{\hyperlink{structsqr__eq_a2fe272b8bf69cc8a1a2daaf09e8e8507}{rts}}.\mbox{\hyperlink{structroots_a5216c1a211a63d865bd09ad79e30cfb5}{x1}}     = 0;}
\DoxyCodeLine{102     ptr\_ex\_eq-\/>\mbox{\hyperlink{structexpected__eq_a7f76d73438937c34157f649c5817aebc}{test\_eq}}.\mbox{\hyperlink{structsqr__eq_a2fe272b8bf69cc8a1a2daaf09e8e8507}{rts}}.\mbox{\hyperlink{structroots_a08ac9d770a5205eede6462a0002695ed}{x2}}     = 0;}
\DoxyCodeLine{103 }
\DoxyCodeLine{104 \}}
...
References sqr\+\_\+eq\+::rts, expected\+\_\+eq\+::test\+\_\+eq, roots\+::x1, and roots\+::x2.
...
Definition at line 107 of file unit\+\_\+test.\+cpp.


\begin{DoxyCode}{0}
\DoxyCodeLine{107                                                              \{}
\DoxyCodeLine{108     \textcolor{keywordflow}{return} (\mbox{\hyperlink{unit__test_8cpp_aeffbfb94b1fd8ab580de8c988b6f870b}{is\_double\_num\_equal}}(peq-\/>\mbox{\hyperlink{structexpected__eq_a7f76d73438937c34157f649c5817aebc}{test\_eq}}.\mbox{\hyperlink{structsqr__eq_a2fe272b8bf69cc8a1a2daaf09e8e8507}{rts}}.\mbox{\hyperlink{structroots_a5216c1a211a63d865bd09ad79e30cfb5}{x1}}, peq-\/>\mbox{\hyperlink{structexpected__eq_a15459797c2ccdd19d372b6f94dafd8f6}{correct\_roots}}.\mbox{\hyperlink{structroots_a5216c1a211a63d865bd09ad79e30cfb5}{x1}}) \&\&}
\DoxyCodeLine{109             \mbox{\hyperlink{unit__test_8cpp_aeffbfb94b1fd8ab580de8c988b6f870b}{is\_double\_num\_equal}}(peq-\/>\mbox{\hyperlink{structexpected__eq_a7f76d73438937c34157f649c5817aebc}{test\_eq}}.\mbox{\hyperlink{structsqr__eq_a2fe272b8bf69cc8a1a2daaf09e8e8507}{rts}}.\mbox{\hyperlink{structroots_a08ac9d770a5205eede6462a0002695ed}{x2}}, peq-\/>\mbox{\hyperlink{structexpected__eq_a15459797c2ccdd19d372b6f94dafd8f6}{correct\_roots}}.\mbox{\hyperlink{structroots_a08ac9d770a5205eede6462a0002695ed}{x2}}));}
\DoxyCodeLine{110 }
\DoxyCodeLine{111 \}}
...
References expected\+\_\+eq\+::correct\+\_\+roots, is\+\_\+double\+\_\+num\+\_\+equal(), sqr\+\_\+eq\+::rts, expected\+\_\+eq\+::test\+\_\+eq, roots\+::x1, and roots\+::x2.
...
Definition at line 113 of file unit\+\_\+test.\+cpp.


\begin{DoxyCode}{0}
\DoxyCodeLine{113                                                         \{}
\DoxyCodeLine{114     \textcolor{keyword}{const} \textcolor{keywordtype}{double} accuracy = 0.01;}
\DoxyCodeLine{115     \textcolor{keywordflow}{return} (fabs(num1 -\/ num2) < accuracy);}
\DoxyCodeLine{116 \}}
...
\DoxyCodeLine{69                                                                 \{}
\DoxyCodeLine{70 }
\DoxyCodeLine{71     \textcolor{keywordtype}{int} root\_count = \mbox{\hyperlink{solver_8h_aa62ebac4c04caf72819ce699f8954186}{square\_solver}}(\&ptr\_ex\_eq-\/>\mbox{\hyperlink{structexpected__eq_a7f76d73438937c34157f649c5817aebc}{test\_eq}});}
\DoxyCodeLine{72 }
...
\DoxyCodeLine{79                 test\_num+1,}
\DoxyCodeLine{80                 root\_count,}
\DoxyCodeLine{81                 ptr\_ex\_eq-\/>\mbox{\hyperlink{structexpected__eq_a7f76d73438937c34157f649c5817aebc}{test\_eq}}.\mbox{\hyperlink{structsqr__eq_a2fe272b8bf69cc8a1a2daaf09e8e8507}{rts}}.\mbox{\hyperlink{structroots_a5216c1a211a63d865bd09ad79e30cfb5}{x1}},}
\DoxyCodeLine{82                 ptr\_ex\_eq-\/>\mbox{\hyperlink{structexpected__eq_a7f76d73438937c34157f649c5817aebc}{test\_eq}}.\mbox{\hyperlink{structsqr__eq_a2fe272b8bf69cc8a1a2daaf09e8e8507}{rts}}.\mbox{\hyperlink{structroots_a08ac9d770a5205eede6462a0002695ed}{x2}},}
\DoxyCodeLine{83                 ptr\_ex\_eq-\/>\mbox{\hyperlink{structexpected__eq_a499d5f3d47ec1e8e60af370c9647d791}{correct\_root\_count}},}
\DoxyCodeLine{84                 ptr\_ex\_eq-\/>\mbox{\hyperlink{structexpected__eq_a15459797c2ccdd19d372b6f94dafd8f6}{correct\_roots}}.\mbox{\hyperlink{structroots_a5216c1a211a63d865bd09ad79e30cfb5}{x1}},}
\DoxyCodeLine{85                 ptr\_ex\_eq-\/>\mbox{\hyperlink{structexpected__eq_a15459797c2ccdd19d372b6f94dafd8f6}{correct\_roots}}.\mbox{\hyperlink{structroots_a08ac9d770a5205eede6462a0002695ed}{x2}});}
\DoxyCodeLine{86         txSetConsoleAttr(15);}
\DoxyCodeLine{87     \}}
\DoxyCodeLine{88 }
\DoxyCodeLine{89     \textcolor{keywordflow}{else} \{}
\DoxyCodeLine{90         txSetConsoleAttr(2);}
\DoxyCodeLine{91         printf(\textcolor{stringliteral}{"{}Тест №\%d пройден успешно\(\backslash\)n"{}}, test\_num+1);}
\DoxyCodeLine{92         txSetConsoleAttr(15);}
\DoxyCodeLine{93     \}}
\DoxyCodeLine{94 \}}
...
References compare\+\_\+correct\+\_\+and\+\_\+test\+\_\+roots(), expected\+\_\+eq\+::correct\+\_\+root\+\_\+count, expected\+\_\+eq\+::correct\+\_\+roots, sqr\+\_\+eq\+::rts, square\+\_\+solver(), expected\+\_\+eq\+::test\+\_\+eq, roots\+::x1, and roots\+::x2.
